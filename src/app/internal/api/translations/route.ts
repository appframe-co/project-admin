...
export async function POST(req: Request) {
    try {
        ...
        const res = await fetch(process.env.URL_PROJECT_ADMIN_API + '/api/translations', {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
                'X-AppFrame-Access-Token': token
...
export async function PUT(req: Request) {
    try {
        ...
        const res = await fetch(`${process.env.URL_PROJECT_ADMIN_API}/api/translations/${body.id}`, {
            method: 'PUT',
            headers: {
                'Content-Type': 'application/json',
                'X-AppFrame-Access-Token': token
