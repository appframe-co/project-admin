...
export function FormEditMenu({menu}: {menu: TMenu}) {
    const { control, handleSubmit, formState, reset, setError } = useForm<TMenu>({defaultValues: menu});

    const router = useRouter();

    const onSubmit: SubmitHandler<TMenu> = async (data) => {
        try {
