...
import { TEntry, TContent, TCurrencyPreview } from '@/types';
...
export function FormNewEntry({content, currencies, sectionIds}: {content: TContent, currencies: TCurrencyPreview[], sectionIds: string|undefined}) {
