import { TBrick, TSchemaBrick, TSections, TStructure } from "@/types";
...
export function StructureSections({defaultValues, groupOfBricks, names}: TProps) {
    ...
    const errorsBrick: any = formState.errors.sections?.bricks ?? [];
            ...
            {activeModalBrick && createPortal(
                ...
                >
                    {brick && schemaBrick && <FormBrick 
                        errors={formState.errors.sections?.bricks && indexBrick !== null ? formState.errors.sections?.bricks[indexBrick]: []}  
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Card title='Bricks'>
                    <div className={styles.bricks}>
                        <Input control={control} name='sections.bricks' type='hidden' />

                        {fields.map((brick, index: number) => (
                            <div key={brick.key} className={!brick.system ? styles.brick : styles.brickSystem} onClick={() => updateBrick(brick, index)}>
                                <div className={styles.name}>{brick.name} {brick.system && '(system)'}</div>
